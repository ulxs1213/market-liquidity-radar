...
class MarketHeatmapThemeCustomizerUiContractTest(unittest.TestCase):
    ...
    def test_theme_assets_use_the_20260714_32_cache_version(self) -> None:
        self.assertEqual(HTML.count("20260714.32"), 2)
        self.assertIn('href="/static/market_heatmap.css?v=20260714.32"', HTML)
        self.assertIn('src="/static/market_heatmap.js?v=20260714.32"', HTML)
